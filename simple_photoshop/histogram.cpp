...
void Histogram::drawBwHstgrm(int xBase, int yBase, int height)
{
    ...
    painter.drawText(xBase, yBase+25, tr("纯黑"));
    painter.drawText(xBase+220, yBase+25, tr("纯白"));

    painter.setPen(Qt::black);

    painter.drawText(xBase+40, yBase-height-10, tr("灰度直方图"));

    painter.drawText(xBase-84, yBase-height/2+5, tr("像素数量"));
...
void Histogram::drawRedHstgrm(int xBase, int yBase, int height)
{
    ...
    painter.drawText(xBase, yBase+25, tr("暗"));
    painter.drawText(xBase+225, yBase+25, tr("亮"));

    painter.setPen(Qt::black);

    painter.drawText(xBase+25, yBase-height-10, tr("红色直方图"));
    painter.drawText(xBase-84, yBase-height/2+5, tr("像素数量"));
...
void Histogram::drawGreenHstgrm(int xBase, int yBase, int height)
{
    ...
    painter.drawText(xBase+15, yBase-height-10, tr("绿色直方图"));

    painter.drawText(xBase-84, yBase-height/2+5, tr("像素数目"));
...
void Histogram::drawBlueHstgrm(int xBase, int yBase, int height)
{
    ...
    painter.drawText(xBase+20, yBase-height-10, tr("蓝色直方图"));
